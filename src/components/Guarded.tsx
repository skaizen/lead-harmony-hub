      ...
      <div className="flex min-h-screen items-center justify-center bg-muted px-4">
        <div className="max-w-md rounded-lg border border-amber-200 bg-amber-50 p-6 text-sm text-amber-900">
          ...
          <p className="mt-2">
            ...
            <code className="rounded bg-muted px-1">VITE_SUPABASE_ANON_KEY</code> in a{" "}
            <code className="rounded bg-muted px-1">.env</code> file at the project root,
            then restart the dev server.
          </p>
          <p className="mt-2">
            See <code className="rounded bg-muted px-1">.env.example</code> and the README
